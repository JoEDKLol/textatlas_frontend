  ...
  <>
    {
      ...
      transition-all duration-200 ease-in-out cursor-pointer px-2 py-0.5
     `} 
      >{props.text}</button>
      :
      <button
      ...
      transition-all duration-200 ease-in-out px-2 py-0.5
      `}
      >{props.disabledText}</button>
    }
  </>
...
const ButtonMessageNext = (props:any) => {
  return (
  <>
    {
      (!props.disabled)?
...
const ButtonMyInfoNext = (props:any) => {
  return (
  <>
    {
      (!props.disabled)?
...
const ButtonCommunitySee = (props:any) => {
  return (
  <>
    {
      (!props.disabled)?
