...
const SignUp = (props:any) => {
  ...
  async function sendEmail(){
    ...
    const resObj = await transaction("post", "user/sendemail", obj, "", false, true, screenShow, errorShow);
    // console.log(resObj);
  ...
  async function signUp(){
    ...
    if(!retObj.yn){
      ...
      const resObj = await transaction("post", "user/signup", obj, "", false, true, screenShow, errorShow);
    ...
    <Portal
      ...
      <div className="static">
        <div className=' fixed top-0 right-0 left-0 z-40 w-[100%] h-[100%] border flex justify-center items-center pb-20  backdrop-blur-xs backdrop-brightness-80 '>
          <div className={block +  "  w-[280px] h-[400px] border-2 rounded-md border-[#4A6D88] shadow-lg shadow-green-900/50  bg-white"}>
            ...
            {(!signUpSeccess)?<>
              ...
              <div className=" flex justify-center mt-4">
                ...
                {(languageStateSet.main_language_set[1])?languageStateSet.main_language_set[2].text[0]:""}  
                </p> 
              </div>
              <div className="mt-4 px-5 text-[#4A6D88]"> 
                <p className="flex justify-between">
                  <input 
                  placeholder={(languageStateSet.main_language_set[1])?languageStateSet.main_language_set[2].text[1]:""} 
                  ...
                  onClick={()=>sendEmail()} 
                  >
                    {(languageStateSet.main_language_set[1])?languageStateSet.main_language_set[2].text[2]:""}
                  </button>
                </p>
              ...
              <div className="relative px-5 mt-2 text-[#4A6D88] ">
                <p className="flex justify-between">
                  <input 
                  placeholder={(languageStateSet.main_language_set[1])?languageStateSet.main_language_set[2].text[3]:""} 
                  type="text" className=" relative w-[100%] h-[10px] text-[11px] border border-[#4A6D88] outline-none py-4 px-3 rounded" 
                  ref={focusNumber}
                  ...
                  >
                  {(languageStateSet.main_language_set[1])?languageStateSet.main_language_set[2].text[4]:""}
                  </button>
                </p>
                <p className="absolute top-[10px] left-[150px] text-xs text-red-500">{timer}</p>
              </div>

              <div className="px-5 text-[#4A6D88] mt-2">
                <p className="flex justify-between">
                  <input 
                  placeholder={(languageStateSet.main_language_set[1])?languageStateSet.main_language_set[2].text[5]:""}  
              ...
              <div className="px-5 text-[#4A6D88] mt-2">
                <p className="flex justify-between">
                  <input 
                  placeholder={(languageStateSet.main_language_set[1])?languageStateSet.main_language_set[2].text[6]:""} 
                  type="password" className="text-[11px] w-[100%] h-[10px] border border-[#4A6D88] outline-none py-4 px-3 rounded"
              ...
              <div className="mt-8 px-5 flex justify-center w-[100%]">
                <p className=" w-[100%]">
                  <button className={signUpObjDisable.classHover + ` border border-[#4A6D88] w-[100%]  text-[#4A6D88] font-bold py-1 px-4 rounded
                  transition-all duration-200 ease-in-out cursor-pointer
                  `}
              ...
              <div className=" flex justify-center w-[100%] mt-1">
                <p className=" text-sm leading-relaxed text-[#4A6D88] text-[10px] mr-1 ">
                  {(languageStateSet.main_language_set[1])?languageStateSet.main_language_set[2].text[7]:""}
                {/* <button onClick={()=>{clickSignUpModal()}} className="font-bold text-grey-700">Create an Account</button> */}
                </p>
                <p className=" text-[10px] text-sm leading-relaxed text-[#4A6D88] font-bold cursor-pointer
                transition-transform duration-300 ease-in-out
                hover:scale-110 transform 
                "
                onClick={()=>moveSignInPage()}
                >
                  {(languageStateSet.main_language_set[1])?languageStateSet.main_language_set[2].text[8]:""}
            ...
            :<>
              ...
              <div className=" flex justify-center">
                <p className="text-[20px] font-bold mt-4 text-[#4A6D88]">
                {(languageStateSet.main_language_set[1])?languageStateSet.main_language_set[2].text[9]:""}  
                </p> 
              </div>
              ...
              <div className=" flex justify-center mt-64">
                <button 
                  ...
                  onClick={()=>moveSignInPage()}
                  >
                  {(languageStateSet.main_language_set[1])?languageStateSet.main_language_set[2].text[10]:""}
                </button>
